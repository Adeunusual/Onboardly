  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className={cn(
          "w-full inline-flex items-center justify-between gap-3 rounded-xl border px-3 py-2 text-sm font-semibold transition",
              ...
              {options.map((o) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "w-full rounded-full border px-3 py-2 text-left text-xs font-semibold transition",
                      "focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--dash-red-soft)]",
                      active
          ...
          <div ref={rootRef} className="relative">
            <button
              ...
              className={cn(
                ...
                "hover:bg-[var(--dash-surface-2)]",
                "focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--dash-red-soft)]",
                !supported && "opacity-60 cursor-not-allowed hover:bg-[var(--dash-surface)]"
              )}
              aria-haspopup="menu"
              aria-expanded={open}
            >
